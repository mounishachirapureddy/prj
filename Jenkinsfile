pipeline {
    ...
    stages {
        stage('Checkout') {
            steps {
                git branch: 'main', url: 'https://git-codecommit.ap-south-1.amazonaws.com/v1/repos/Snapcoins', credentialsId: 'AnuragKache-at-083118395813fozzoJZ7Oo8GIMysg0TYmZX2Bs3uS09ARoYmd93+TGY='
            }
        }
        stage('Build') {
            steps {
