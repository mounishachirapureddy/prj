    ...
    const fetch = async () => {
      try {
        const response = await axios.get(
          `http://127.0.0.1:3002/api/getprofile${state.datatopass.userid}`
        );
                  ...
                  <div className="main_info">
                    <div className="clearfix mb-3">
                      ...
                      <div className="score_in">
                        <i className="bi bi-stack me-1"></i> 123
                ...
                <form>
                  <div class="sign-in-wrapper">
                    <p>
                      ...
                      <strong>"{state.datatopass.title}"</strong> from{" "}
                    ...
                    <div class="form-group">
                      ...
                      <input
                        type="text"
                        class="form-control"
                        placeholder={`${state.datatopass.price}`}
                        disabled="true"
                      />
                    </div>
                    <ul>
